...
module event {
  source              = "../../events/v1"
  webhook_url         = var.environment == "production" ? "https://hrm-production.tl.techmatters.org/lambda/twilioEventStreams" : "https://hrm-development.tl.techmatters.org/lambda/twilioEventStreams"  
