...
locals {
  ...
  local_config = {
    ...
    flow_vars = {
      ...
      #VC SMS
      send_message_vc_sms_welcome    = "Thank you for contacting the VictimConnect Resource Center. To receive services in a preferred language other than English, please call 1-855-4-VICTIM (1-855-484-2846). \n\nGracias por contactar el Centro de Recursos VictimConnect. La línea de VictimConnect no ofrece servicios por chat en español en este momento. Para obtener servicios en español o para hablar con un intérprete, por favor llame al 1-855-4-VICTIM (1-855-484-2846)."
      ...
      #DCVH  SMS
      send_message_dcvh_sms_welcome    = "Thank you for contacting the DCVH. To receive services in a preferred language other than English, please call 1-855-4HELPDC (1-844-443-5732). \n\nGracias por contactar a DC Victim Hotline. Nuestra línea para asistencia de víctimas en DC no ofrece servicio de chat en español en este momento. Para ayuda en español, por favor llame al 1-855-4HELPDC (1-844-443-5732). Nuestro servicio es completamente anónimo. Pedimos que no comparta enlaces, imágenes, videos o cualquier otro material, ya que no son compatibles con nuestro sistema. Si desea continuar con el servicio de texto en inglés, un especialista le asistirá pronto."
