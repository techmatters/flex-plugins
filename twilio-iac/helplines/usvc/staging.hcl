...
locals {
  ...
  local_config = {
    ...
    flow_vars = {
      ...
      #DCVH Voice
      play_message_dcvh_voice_en_welcome        = "Thank you for calling the DC Victim Hotline. Gracias por llamar al centro de  recursos de víctimas en Washington, DC."
      play_message_dcvh_voice_es_welcome        = "Gracias por llamar al centro de  recursos de víctimas en Washington, DC."
      gather_input_dcvh_voice_en_language       = "We provide services for both survivors and professionals. If you are a survivor or professional seeking services related to emotional support, information or referrals, press 1 for English or 2 for Spanish/Gracias por llamar a DC Victim Hotline. If you are a professional seeking sexual assault dispatch services, press 3."
