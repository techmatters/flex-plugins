locals {
  ...
  local_config = {
    ...
    custom_task_routing_filter_expression = "channelType IN ['instagram','messenger','web','whatsapp','telegram','line','voice', 'modica','external'] OR  twilioNumber == 'messenger:131329426738030' "
