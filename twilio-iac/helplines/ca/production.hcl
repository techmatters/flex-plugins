locals {
  ...
  local_config = {
    ...
    flow_vars = {
      ...
      check_queue_capacity_function_sid = "ZHc3ca5f3292a9d07d78921141bdd9fba6"
      ...
      cancel_task_function_sid          = "ZH9b694edd6fefd02ab3b157d8fc48416d"
    }
    ...
    phone_numbers = {
      khp : ["+12268878353", "+18663931921", "+16476977602"],
