locals {
  ...
  local_config = {
    ...
    task_queues = {
      ...
      g2t_ns_en : {
        "target_workers" = "routing.skills HAS 'G2TNSEn' OR routing.skills HAS 'G2TNSENsk'",
        "friendly_name"  = "Good2Talk NS English"
      },
      g2t_ns_fr : {
        "target_workers" = "routing.skills HAS 'G2TNSFr' OR routing.skills HAS 'G2TNSFRsk'",
        "friendly_name"  = "Good2Talk NS French"
      },
      g2t_on_en : {
        "target_workers" = "routing.skills HAS 'G2TONEn' OR routing.skills HAS 'G2TONENsk'",
        "friendly_name"  = "Good2Talk ON English"
      },
      g2t_on_fr : {
        "target_workers" = "routing.skills HAS 'G2TONFr' OR routing.skills HAS 'G2TONFRsk'",
      ...
      "988_en" : {
        "target_workers" = "routing.skills HAS '988En' OR routing.skills HAS '988ENsk'",
        "friendly_name"  = "988 English"
      },
      "988_fr" : {
        "target_workers" = "routing.skills HAS '988Fr' OR routing.skills HAS '988FRsk'",
        "friendly_name"  = "988 French"
      },
      "988_ns_fr" : {
        "target_workers" = "routing.skills HAS '988NSFr' OR routing.skills HAS '988NSFRsk'",
