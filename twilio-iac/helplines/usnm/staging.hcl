...
locals {
  ...
  local_config = {
    ...
    flow_vars = {
      ...
      send_wait_sms_tya_info                                          = "NAMI is now offering a Teen and Young Adult HelpLine service. It brings together young people with shared experiences and equips specially trained HelpLine Specialists with knowledge and insights into what helps."
      send_wait_sms_fcg_info                                          = "NAMI is now offering a Family Caregiver HelpLine service. It brings together family caregivers with shared experiences and equips HelpLine Specialists with knowledge and insights into what helps."
