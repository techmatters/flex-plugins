...
locals {
  ...
  local_config = {
    ...
    flow_vars = {
      ...
      childhelp_voice_recording_consent_en_message          = "To help us improve our services, this call may be recorded. Recordings are deleted within 24 hours. You may hang up at any time. By continuing, you consent to the recording."
      childhelp_voice_recording_consent_es_message          = "Para ayudarnos a mejorar nuestros servicios, esta llamada puede ser grabada. Las grabaciones se eliminan dentro de las 24 horas. Usted puede colgar en cualquier momento. Al continuar, usted consiente la grabación."
