...
locals {
  ...
  local_config = {
    ...
    flow_vars = {
      ...
      # ChildHelp -  SMS
      childhelp_sms_language_message = "Thanks for texting. For emergencies contact 911. Standard msg rates may apply. Terms of service can be found here: https://www.childhelphotline.org/terms-of-service . By continuing, you agree to our terms of service. If you cannot access the terms of service, you can also access help by calling the hotline at 800-422-4453."
      ...
      childhelp_sms_failure_message = "We are sorry, we had a technical issue. Please trying texting again or call 800-422-4453 "
