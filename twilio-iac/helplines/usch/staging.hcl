...
locals {
  ...
  local_config = {
    ...
    flow_vars = {
      ...
      childhelp_sms_eng_language_message         = "For emergencies contact 911. By continuing, you agree to our terms of service. If you cannot access the terms of service, you can also access help by calling the hotline at 800-422-4453."
