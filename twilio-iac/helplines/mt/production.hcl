locals {
  ...
  local_config = {
    ...
    custom_task_routing_filter_expression = "channelType IN ['web', 'messenger', 'whatsapp', 'instagram'] OR  twilioNumber == 'instagram:17841400289612325', 'messenger:325981127456443', 'whatsapp:+15077097720'"
