...
ifdef OS
    ...
    MY_RELATIVE_PATH := $(shell echo $(CURDIR) | sed -e "s|$(GIT_ROOT)||")
    DIND_ARG = -v /var/run/docker.sock:/var/run/docker.sock
endif
...
SECRETS = -e AWS_REGION -e AWS_DEFAULT_REGION -e AWS_SECRET_ACCESS_KEY -e AWS_ACCESS_KEY_ID -e TWILIO_ACCOUNT_SID -e TWILIO_AUTH_TOKEN -v ~/.aws:/root/.aws -e GITHUB_OWNER -e GITHUB_TOKEN
