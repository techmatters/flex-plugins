...
def print_service_configuration_info(service_configuration: ServiceConfiguration):
    print("\n------------------")
    print(f"Environment: {service_configuration.environment}")
    print(f"Helpline Code: {service_configuration.helpline_code}")
    print(f"Account SID: {service_configuration.account_sid}")
    print("")
...
def show(service_configuration: ServiceConfiguration):
    ...
    show_plan(service_configuration)
...
def show_plan(service_configuration: ServiceConfiguration):
    print("Plan:")
    print_plan(service_configuration.plan)


def update(service_configuration: ServiceConfiguration):
    show_plan(service_configuration)
    if config.get_value('dry_run'):
