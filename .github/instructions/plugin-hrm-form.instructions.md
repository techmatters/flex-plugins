...
1. Create an appConfig.js under plugin-hrm-form/public - use appConfig.template.e2e.js as a template and replace the top 3 placeholder values with environment variables, accountSid is SITE_ACCOUNT_SID, connection is SITE_CONNECTION_SID and clientId IS SITE_CLIENT_ID
