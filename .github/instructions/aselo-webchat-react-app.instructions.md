...
When debugging the flex website, you can use the version deployed for the AS development account unless instructed otherwise. The URL is https://assets-development.tl.techmatters.org/aselo-webchat-react-app/as/