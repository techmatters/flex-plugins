...
const preEngagementConfig: PreEngagementFormDefinition = {
  ...
  fields: [
    ...
    {
      type: "select",
      name: "¿Con cuál género te identificas?",
      label: "gender",
      defaultValue: "",
      options: [
        {
    ...
    {
      type: "select",
      name: "¿Cuál es tu sexo asignado al nacer?",
      label: "biologicalSex",
      defaultValue: "",
      options: [
        {
    ...
    {
      type: "select",
      name: "Actualmente te identificas como:",
      label: "sexualAndAffectiveOrientation",
      defaultValue: "",
      options: [
        {
          value: "",
    ...
    {
      type: "select",
      name: "¿Eres una persona intersexual?",
      label: "intersexuality",
      defaultValue: "",
      options: [
        {
          value: "",
    ...
    {
      type: "select",
      name: "¿Eres una persona neurodivergente?",
    ...
    {
      type: "select",
      name: "¿Qué tipo de ayuda estás buscando?",
      label: "typeOfHelp",
      defaultValue: "",
      options: [
        {
...
const translations: Translations = {
  ...
  "es-CL": {
    ...
    FieldValidationInvalidEmail:
      "Por favor provea una dirección válida de email",
