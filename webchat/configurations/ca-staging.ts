...
const translations: Translations = {
  'en-CA': {
    ...
    Asian:
      'South, East, or Southeast Asian (e.g., Korean, Chinese, Japanese, Cambodian, Filipino, Indonesian, Laotian, Vietnamese, Pakistani, Sri Lankan, etc.)',
  ...
  'fr-CA': {
    ...
    Asian:
      'Asiatique de sud, de l’est, ou du sudest (ex. Coréen.ne, Chinois.e, Japonais.e, Cambodgien.ne, Philippin.e, Indonésien.ne, Laotien.ne, Vietnamien.ne, Pakistanais.e, Sri Lankais.e, etc.)',
  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'Homosexual (Gay or Lesbian), Asexual, Bisexual, Pansexual, Two-Spirit', label: 'HomosexualAsexualBisexualPansexual' },
