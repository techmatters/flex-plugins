...
export const instagramToFlexHandler: AccountScopedHandler = async (
  ...
  const onMessageSentWebhookUrl = `${process.env.WEBHOOK_BASE_URL}/lambda/twilio/account-scoped/customChannels/instagram/flexToInstagram?recipientId=${senderExternalId}`;
