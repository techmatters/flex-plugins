...
describe('generateDefaultForm', () => {
  ...
  test('Item with default specified in items map - returns default in the array', () => {
    const itemDefault = { type: FormInputType.Input, name: 'myItemName', label: 'My Item' } as const;
  ...
  describe('Ordering', () => {
    const itemDefault1 = { type: FormInputType.Input, name: 'myItemName1', label: 'My Item 1' } as const;
    const itemDefault2 = { type: FormInputType.Input, name: 'myItemName2', label: 'My Item 2' } as const;
    const itemDefault3 = { type: FormInputType.Input, name: 'myItemName3', label: 'My Item 3' } as const;
    const itemDefault4 = { type: FormInputType.Input, name: 'myItemName3', label: 'My Item 4' } as const;
