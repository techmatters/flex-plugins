...
export const formatNumberFromTask = (task: CustomITask, contactNumberFromTask: string) =>  task.channelType === channelTypes.twitter ? `@${task.attributes.twitterUserHandle}` : contactNumberFromTask; 
