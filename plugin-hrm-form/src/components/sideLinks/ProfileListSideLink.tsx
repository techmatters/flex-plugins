...
const ProfileListSideLink: React.FC<Props> = ({ showLabel, activeView, onClick }) => {
  return (
    <SideLink
      showLabel={showLabel}
      ...
      onClick={onClick}
    >
      <Template code="SideNavProfileList" />
    </SideLink>
  );
};

ProfileListSideLink.displayName = 'ProfileListSideLink';

export default ProfileListSideLink;
