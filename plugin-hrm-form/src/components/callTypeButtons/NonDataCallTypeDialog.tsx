...
type NonDataCallTypeDialogProps = {
  isOpen: boolean;
  isCallTask: boolean;
...
const NonDataCallTypeDialog: React.FC<NonDataCallTypeDialogProps> = ({
  isOpen,
  isCallTask,
  isInWrapupMode,
  handleConfirm,
  ...
  const renderTemplate = () => {
    let code;
    if (isInWrapupMode) {
      code = 'CallType-CloseContact';
    } else if (isCallTask) {
      code = 'TaskHeaderEndCall';
    } else {
      code = 'TaskHeaderEndChat';
    }
