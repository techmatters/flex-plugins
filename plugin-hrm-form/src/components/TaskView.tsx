...
const TaskView: React.FC<Props> = ({ task }) => {
  ...
  console.log(
    `TaskView: checking contact state for ${task?.taskSid} and contactId ${taskContactId}`,
  );
  ...
  console.log(`TaskView: selected contact state`, savedContact, draftContact, metadata);
