...
test('Test <QueuesStatus> after update', () => {
  ...
  const queuesStatusState = {
    queuesStatus: {
      ...
      Q4: { facebook: 0, sms: 0, voice: 0, web: 0, whatsapp: 0, twitter: 0, instagram: 0, longestWaitingDate: null },
      Admin: {
        facebook: 9,
        sms: 9,
        voice: 9,
...
test('Test <QueuesStatus> after error', () => {
  ...
  const queuesStatusState = {
    queuesStatus: {
      ...
      Admin: { facebook: 9, sms: 9, voice: 9, web: 9, whatsapp: 9, twitter: 0, instagram: 0, longestWaitingDate: null },
    },
