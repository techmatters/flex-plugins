    ...
    Object.values(CaseActions)
      .flatMap(action => [
        ...
        },
        {
          ...
          isSupervisor: false,
          expectedResult: false,
          expectedDescription: 'nobody condition always denies',
        },
        {
          action,
          ...
          isSupervisor: true,
          expectedResult: true,
          expectedDescription: 'nobody in first set, but isSupervisor in second set allows',
        },
        {
          action,
          ...
          isSupervisor: false,
          expectedResult: false,
          expectedDescription: 'nobody combined with isCreator still denies',
        },
      ])
    ...
    Object.values(ContactActions)
      .flatMap(action => [
        ...
        },
        {
          ...
          isSupervisor: false,
          expectedResult: true,
          expectedDescription: 'nobody in first set, but isOwner in second set allows',
        },
        {
          action,
          conditionsSets: [['nobody', 'isOwner']],
          ...
          isSupervisor: false,
          expectedResult: false,
          expectedDescription: 'nobody combined with isOwner still denies',
        },
      ])
      .map(addPrettyPrintConditions),
  ).test(
    ...
    Object.values(ProfileActions)
      .flatMap(action => [
        ...
        },
        {
          ...
          isSupervisor: true,
          expectedResult: false,
          expectedDescription: 'nobody combined with isSupervisor still denies',
        },
      ])
      .map(addPrettyPrintConditions),
  ).test(
    ...
    Object.values(ContactFieldActions)
      .flatMap(action => [
        ...
        // Test 5: 'nobody' condition tests
        {
          ...
          field: testField,
          expectedResult: true,
          expectedDescription: 'nobody with no field condition - field not restricted so allowed',
        },
        {
          action,
          conditionsSets: [[{ field: testField }, 'nobody']],
          workerSid: 'owner',
          isSupervisor: true,
          field: testField,
          expectedResult: false,
          expectedDescription: 'nobody combined with field condition denies',
        },
        {
          action,
          conditionsSets: [[{ field: testField }, 'nobody'], ['isSupervisor']],
          workerSid: 'not owner',
          isSupervisor: true,
          field: testField,
          expectedResult: true,
          expectedDescription: 'nobody with field in first set, but isSupervisor in second set allows',
        },
        {
          action,
          conditionsSets: [[{ field: testField }, 'nobody'], ['isOwner']],
          workerSid: 'not owner',
          isSupervisor: false,
          field: testField,
          expectedResult: false,
          expectedDescription: 'nobody with field in first set denies, isOwner false in second set',
        },
      ])
      .map(addPrettyPrintConditions),
  ).test(
