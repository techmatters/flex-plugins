...
export const playNotification = (notificationTone: string) => {
  ...
  // While AudioPlayerManager proports to have a queue, it seems to be 'full' if anything is playing and rejects any further play requests for the duration logging an error
