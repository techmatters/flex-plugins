...
import { Profile, ProfileFlag, ProfileSection } from '../types';
...
export type UseEditProfileSection = {
//   associateProfileFlag: (profileFlagId: ProfileSection['id']) => void;
//   disassociateProfileFlag: (profileFlagId: ProfileSection['id']) => void;
};

export type UseProfileFlags = UseAllProfileFlags & UseEditProfileSection & { profileFlags?: ProfileFlag[] };
