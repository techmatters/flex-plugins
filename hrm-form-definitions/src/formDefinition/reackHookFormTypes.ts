/**
 * These types are copied from 'react-hook-form' because there is no way to import the types without the rest of the code, which depends on React
 */

export declare type Message = string;
export declare type ValidationValue = boolean | number | string | RegExp;
export declare type ValidationRule<TValidationValue extends ValidationValue = ValidationValue> =
  | TValidationValue
